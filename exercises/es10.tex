\begin{exercise}{
    ...
    \lstinputlisting[title=$P_\text{Linear Equalities}$]{exercises/es10/p_le.while}
    \lstinputlisting[title=$Q_\text{Linear Equalities}$]{exercises/es10/q_le.while}
    \lstinputlisting[title=$P_\text{Convex Polyhedra}$]{exercises/es10/p_cp.while}
    \lstinputlisting[title=$Q_\text{Convex Polyhedra}$]{exercises/es10/q_cp.while}
\end{exercise}
